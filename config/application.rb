...
module Greenlight
  class Application < Rails::Application
    ...
    config.branding_image_default = "https://class.video.wiki/images/VideoWiki_Logo.svg"
    ...
    config.attendees_post_endpoint = "https://api.cast.video.wiki/api/class/joinee/details/"
    config.attendees_get_endpoint = "https://api.cast.video.wiki/api/get/class/joinee/details/?class_id"
